...
public class Lab2Controller {
    ...
    public String lockQueue(@RequestParam int queueID, @RequestParam int userId, @RequestParam boolean isLocked) {
    ...
    public String findAll() {
        return queueService.getAllQueues().toString();
    }
}
